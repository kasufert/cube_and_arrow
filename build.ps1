Remove-Item dbg/main.exe, dbg/*.obj, dbg/*.ilk, dbg/*.pdb
...
cl.exe src/main.cpp /DSFML_STATIC /DGLEW_BUILD /DWINDOWS /Zc:nrvo- /Zi /W4 /FC /Fodbg\ `
    /I$IncDir /I$LibDir2 /external:anglebrackets /external:W0 `
    /std:c++20 /EHsc `
    /link /LIBPATH:$LibDir /DEBUG `
